...
public class ProcessVariablesTest {
    ...
    public void deploymentProcessDefinition_inputStream() {
        InputStream inputStreambpmn = this.getClass().getResourceAsStream("/docs/bpmn/processVariables.bpmn");
        InputStream inputStreampng = this.getClass().getResourceAsStream("/docs/bpmn/processVariables.png");
        Deployment deployment = processEngine.getRepositoryService()//与流程定义和部署对象相关的Service
                ...
                .deploy();//完成部署
        System.out.println("部署ID：" + deployment.getId());//35001
    ...
    public void startProcessInstance() {
        ...
        System.out.println("流程实例ID:" + pi.getId());//流程实例ID 37501
        System.out.println("流程定义ID:" + pi.getProcessDefinitionId());//流程定义ID processVariables:1:35004
    }
    ...
    public void setVariables() {
        ...
        String taskId = "45002";
        /**一：设置流程变量，使用基本数据类型*/
        taskService.setVariableLocal(taskId, "请假天数", 5);//与任务ID绑定 act_ru_variable 表中task_id有数据
    ...
    public void getVariables() {
        ...
        System.out.println(variables1);//少了请假天数，因为是taskLocal的
...
//		taskService.getVariables(taskId, variableNames);//使用任务ID，获取流程变量的值，通过设置流程变量的名称存放到集合中，获取指定流程变量名称的流程变量的值，值存放到Map集合中
    ...
    public void completeMyPersonalTask() {
        ...
        processEngine.getTaskService()//与正在执行的任务管理相关的Service
                .complete(taskId);
        System.out.println("完成任务：任务ID：" + taskId);//这个taskId关联的taskLocal参数消失
    }
